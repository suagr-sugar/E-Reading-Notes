...
output_file = r"D:\0APYTHON\xhs projects\for WeChat reading\0106\results\3结果.xlsx"
...
with open(input_file, "r", encoding="utf-8") as file:
    ...
    for line in lines:
        ...
        if date_match:
            ...
            if current_date and current_comment:
...
if current_date and comment_accumulator:
    data["内容"].append("")
